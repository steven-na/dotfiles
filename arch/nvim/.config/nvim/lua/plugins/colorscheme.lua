return {
    ...
    config = function()
        ...
        local fallback = {
            ...
            base06 = "#f5c2e7", base07 = "#b4befe", base08 = "#f38ba8",
        ...
        if watcher then
            watcher:start(palette_path, {}, vim.schedule_wrap(function()
                apply(load_palette())
            end))
        end

        -- Toggle: wipe background colors so the terminal bg shows through
